...
ABC102 adminsteres two oral doses to each subject, once at baseline and once on D15.  
```{r}
ex <- EX %>%
...
Some SDTM and ADaM datasts do not have the information we need in the ideal format. In this example, we manually create numeric nominal days and timepoints.  
```{r}
pc <- PC %>%
