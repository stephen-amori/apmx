...
#   expect_error(cov_apply(df = pkdf_cov_me, id.by = "USUBJID", time.by = "DTIM", cov.rnd = 3),
#       "Dataframe must contain FDOSE \\(date/time of first dose\\) if merging with DTIM.")
#   # expect_error(pkdf_cov_me, "")
...
#       "At least one subject is included in the dataframe but not in covariates.")
# })
